  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="px-4 py-2 h-12 ml-auto md:py-2 text-primary-500 bg-white font-medium rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 transition-colors duration-200 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800"
      >
        New contract
      </Link>
    </section>
